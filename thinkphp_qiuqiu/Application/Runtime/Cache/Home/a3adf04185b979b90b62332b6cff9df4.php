...
<div data-role=“page” id="schedule">
  ...
  <a href="<?php echo U('Home/person/PersonalCenter');?>" data-role="button" class="ui-btn ui-corner-all ui-icon-carat-l ui-btn-icon-notext"></a>
   <h1>我的日程</h1> 
   <a href="<?php echo U('Home/person/schedule');?>" data-role="button" class="ui-btn ui-corner-all ui-icon-recycle ui-btn-icon-notext"></a>
</div>
<div data-role="content" align="center">
<img src="/thinkphp_3.2.3/Public/front/images/2.png" >
<p>暂无日程</p>
</div>
