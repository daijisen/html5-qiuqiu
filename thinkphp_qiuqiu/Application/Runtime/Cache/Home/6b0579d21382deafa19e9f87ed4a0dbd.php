...
<head>
    ...
    <link rel="stylesheet" href="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/res/jquery.mobile-1.4.5.min.css">
    ...
    <script src="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/res/jquery-2.2.2.js"></script>
    <script src="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/res/jquery.mobile-1.4.5.min.js"></script>
    ...
    <link rel="stylesheet" href="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/css/themes/blue.css" />
    <link rel="stylesheet" href="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/css/themes/jquery.mobile.icons.min.css" />
    <script>
        jQuery(function(){
...
<div data-role="content">
    ...
    <div class="camera_wrap camera_azure_skin" id="camera_wrap_1">
        <div data-thumb="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/images/26.png" data-src="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/images/117.png">
            <div class="camera_caption fadeFromBottom">
                低调的群熊，请不要忽视他们
            </div>
        </div>
        <div data-thumb="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/images/27.png" data-src="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/images/115.png">
            <div class="camera_caption fadeFromBottom">
                伊戈达拉生涯集锦
            </div>
        </div>
        <div data-thumb="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/images/28.png" data-src="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/images/116.png">
            <div class="camera_caption fadeFromBottom">
                我和克拉克森击个掌
            </div>
        </div>
                ...
                <ul data-role="listview" >
                    <li>
                        <a href="<?php echo U('Home/news/newsneirong');?>"  rel="external">
                            <img src="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/images/111.png">
                    ...
                    <li>
                        <a href="<?php echo U('Home/news/newsneirong');?>">
                            <img src="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/images/112.png">
                            <h2>卡莱尔称赞马刺</h2>
                    ...
                    <li>
                    <a href="<?php echo U('Home/news/newsneirong');?>">
                        <img src="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/images/113.png">
                        <h2>比尔砍下职业新高</h2>
                        <p>此外，也是生涯背靠背砍下30分</p>
                    </a>
                    </li>
                    <li>
                        <a href="<?php echo U('Home/news/newsneirong');?>">
                            <img src="/html5-qiuqiu/thinkphp_qiuqiu/Public/front/images/118.png">
                            <h2>巴特勒戴维斯获周最佳</h2>
                            <p>公牛鹈鹕均三胜一负</p>
                        </a>
                    </li>
