...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">所有评论</span></div>
        </div>
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="<?php echo U('Admin/comment/destoryBatch');?>">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="<?php echo ($vo["comid"]); ?>" type="checkbox"></td>
                            <td>
                                <input name="ids[]" value="<?php echo ($vo["comid"]); ?>" type="hidden">
                                <input class="common-input sort-input" name="ord[]" value="<?php echo ($vo["comid"]); ?>" type="text">
                            </td>
                            <td><?php echo ($vo["pid"]); ?></td>
                            <td><?php echo ($vo["content"]); ?></td>
                            <td><?php echo ($vo["time"]); ?></td>
                            <td>
                                <a class="link-del" href="<?php echo U('Admin/comment/destory');?>/comid/<?php echo ($vo["comid"]); ?>">删除</a>
                            </td>
